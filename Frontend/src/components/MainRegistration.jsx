...
const MainRegistration = () => {
  ...
  return (
    <div className="min-h-screen bg-carbon text-white relative">
      ...
      {/* Cover Pic Section */}
      <div className="w-full h-[50vh] relative overflow-hidden bg-carbon border-b border-white/5">
        {/* Cover Image with high opacity for maximum visibility */}
        <div 
          className="absolute inset-0 bg-cover bg-center transition-transform duration-1000 transform hover:scale-102"
          style={coverPhoto ? {
            backgroundImage: `url(${coverPhoto})`,
            opacity: 0.9
          } : {
            backgroundImage: `linear-gradient(to bottom, rgba(17, 17, 17, 0.2), rgba(17, 17, 17, 0.5)), url('/logo.jpg')`,
            opacity: 0.8
          }}
        />
        {/* Subtle overlay gradient at the bottom to blend with the carbon background */}
